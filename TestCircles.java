...
/**
 * Author TestCircles.java - GrayFox | Ilya Lisin
...
public class TestCircles {
    public static void main(String[] args) {
        // Проход цикла называются итерациями.
        for (int i = 0; i < 0; i++) {
...
//        }
        ...
        // Бессконечный цикл
//        for (int i = 1; i != 0; i++) {
//            System.out.println("[ERROR] core: " + i);
//        }

        //i += 5 - в предыдущем уроке нам говорили, что эта запись все помнят, равна i = i + 5.
        ...
        // Бессконечный цикл
//        for (; ; ) {
//            System.out.println("Я бессконечно выношу мозг программистам");
//        }
