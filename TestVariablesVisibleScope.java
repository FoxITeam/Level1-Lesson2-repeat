...
/**
 * Author TestVariablesVisibleScope.java - GrayFox | Ilya Lisin
...
public class TestVariablesVisibleScope {

    // Если мы делаем много циклов, лучше делать инициализацию переменных для счетчиков внутри методов, а то делать его внешним неудобно, а с
    // внутренним будет удобно в дальнейшем следить по отладке (жучек зелененький).
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; // Создаем переменную
             j < 0; // указываем для цикла условие
             j++) { // говорим, с каким шагом будет проходить наш цикл
            System.out.println(); // А дальше описываем само Тело цикла или то, что он будет выполнять.
        }
    }

    public static void testMetdod() {
        var_a = 0;
        int i = 10;
    }
}
